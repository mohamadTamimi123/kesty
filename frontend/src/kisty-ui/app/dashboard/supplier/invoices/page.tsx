...
export default function SupplierInvoicesPage() {
  ...
  const fetchInvoices = useCallback(async () => {
    ...
    try {
      setIsLoading(true);
      const data = await apiClient.getSupplierInvoices();
    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-brand-medium-blue">
          مشاهده و مدیریت فاکتورهای صادر شده
        </p>
      </div>
        ...
        {filteredInvoices.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-brand-medium-blue mb-2">
              {filterStatus === 'ALL'
                ? 'شما هنوز فاکتوری صادر نکرده‌اید'
            ...
            <table className="w-full">
              <thead className="bg-brand-off-white border-b border-brand-medium-gray">
                <tr>
                  ...
                  <th className="px-6 py-4 text-right text-sm font-semibold text-brand-dark-blue">مشتری</th>
                  ...
                  <tr key={invoice.id} className="hover:bg-brand-off-white transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="text-brand-medium-blue">
                        {invoice.customer?.fullName || 'مشتری'}
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="font-semibold text-brand-dark-blue">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex gap-2">
                        <Link href={`/dashboard/supplier/invoices/${invoice.id}`}>
